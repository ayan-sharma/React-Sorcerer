...
function MyEditor({ setStyles, styles }) {
  ...
  return (
    <div className='h-full w-full'>
      <Button 
      handleClick={()=>saveContentToLocalStorage(editorState)} 
      classNameValue={`absolute right-[30px] top-[100px] px-6 py-2 font-medium bg-indigo-500 text-white w-fit transition-all shadow-[3px_3px_0px_black] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px]`} 
      title={"Save"} />
      <Editor
